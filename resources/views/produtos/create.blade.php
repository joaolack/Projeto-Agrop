            ...
            <div class="p-6 bg-white dark:bg-gray-800">
                ...
                <form action="{{ route('produtos.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nome" name="nome" value="{{ old('nome') }}" class="form-input mt-1 block w-full rounded-lg shadow-md @error('nome') border-red-500 @enderror" required>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="categoria_id" name="categoria_id" required class="form-select @error('categoria_id') border-red-500 @enderror rounded-lg shadow-md" >
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" min="0" id="preco_custo" value="{{ old('preco_custo') }}" name="preco_custo" class="form-input mt-1 block w-full @error('preco_custo') border-red-500 @enderror rounded-lg shadow-md" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" min="0.01" id="preco_venda" name="preco_venda" value="{{ old('preco_venda') }}" class="form-input mt-1 block w-full @error('preco_venda') border-red-500 @enderror rounded-lg" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" min="0" id="quant_estoque" name="quant_estoque" value="{{ old('quant_estoque', 0) }}" class="form-input mt-1 block w-full @error('quant_estoque') border-red-500 @enderror rounded-lg shadow-md" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" min="0" id="estoque_min" name="estoque_min" class="form-input mt-1 block w-full @error('estoque_min') border-red-500 @enderror rounded-lg shadow-md" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" id="data_validade" name="data_validade" value="{{ old('data_validade') }}" class="form-input mt-1 block w-full @error('data_validade') border-red-500 @enderror rounded-lg shadow-md" required>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="descricao" name="descricao" rows="3" class="form-textarea mt-1 block w-full  @error('descricao') border-red-500 @enderror rounded-lg shadow-md" required></textarea>
